...
import org.user.query.service.subscriber.UserQueryEventSubscriber;
...
public class UserQueryServiceMain {
	...
	class MyConfiguration extends WebMvcConfigurerAdapter {
		@Bean
        public UserQueryEventSubscriber userQueryEventSubscriber(UserQueryService userQueryService) {
			return new UserQueryEventSubscriber(userQueryService);
		}
		@Bean
