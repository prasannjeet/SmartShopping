...
public class GatewayServiceMain {
  ...
  @EnableJpaRepositories(basePackages = {"org.gateway.service.repository"})
  @EnableEventHandlers
  class MyConfiguration extends WebMvcConfigurerAdapter {
      ...
      @Bean
      public GatewayService gatewayService(AggregateRepository<GatewayAggregate, GatewayCommand> aggregateRepository,GatewayRepository gatewayRepository) {
          return new GatewayService(aggregateRepository, gatewayRepository);
      }
